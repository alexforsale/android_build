...
$(warning *  Android can only be built by versions 3.81 and 3.82 and 4.0.)
...
java_version := $(shell echo '$(java_version_str)' | head -n 1 | grep '^java .*[ "]1\.6[\. "$$]')
...
javac_version := $(shell echo '$(java_version_str)' | head -n 1 | grep '[ "]1\.6[\. "$$]')
